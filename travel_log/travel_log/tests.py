...
class TripViewTests(TestCase):
    def setUp(self):
        ...
        self.trip = Trip.objects.get(user=self.user1)
    ...
    def test_logged_in_user_can_logout(self):
        ...
        response = self.client.get('/travel_log/' + str(self.trip.id) + '/view/')
    ...
    # Case 5: User is not legged in -- Should not see Logout link
